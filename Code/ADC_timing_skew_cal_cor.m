...
rng(10);
Mis_TS = 0.005 * 1/fs * randn(1, n_ch);    % Inter-channel Clock Jitter
...
for iter = 1 : iteraion
    ...
    % concat signals of different channels（时间交织，通道合并）
    for i=1:n_ch
...
for i = 1:n_ch
    plot(1:iteraion, 1e12*delay_err_log(:, i), 'LineWidth', 1.5, 'Color', colors(i,:), ...
